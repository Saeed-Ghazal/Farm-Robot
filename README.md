...
1. **Navigation & Sensing**  
   Robot drives autonomously using motor drivers and avoids obstacles via the ultrasonic sensor.

2. **Planting & Watering**  
   At designated locations, the mini servo lowers seeds into soil and the water pump irrigates them.

3. **Data Collection**  
   Sensors record temperature, humidity, light intensity, wind speed, and rain, sending data to the mobile app.

4. **Remote Operation**  
   Users can override autonomous behavior, view live video, and control functions from the app.

---

## 📱 Mobile App

- Connects to **HC-06 Bluetooth module** (default PIN: 1234).  
